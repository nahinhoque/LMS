      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-9  max-w-2xl w-full text-gray-700 bg-[#070f5509] border border-gray-200 rounded-xl shadow-lg backdrop-blur-sm p-6'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            <p className='text-md font-bold'>Course Thumbnail</p>
            <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
              <img src={assets.file_upload_icon} alt="" className='p-3 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700
       text-white font-semibold rounded-lg w-[50px] h-9  
         shadow-md hover:shadow-lg hover:opacity-95
         transform transition duration-150 ease-in-out hover:scale-105
         focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2  bg-blue-500 
         ' />
        ...
        <div>
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  ...
                  <div className='inline-flex  bg-[#00000028] text-black p-2 rounded cursor-pointer mt-2' onClick={() => handleLecture('add', chapter.chapterId)}>
                    +  Add Lecture
                  </div>
                </div>
              )}
          ...
          <div className='flex justify-center items-center bg-[#1111117c] from-blue-500 via-blue-600 to-blue-700
       text-white font-semibold rounded-lg w-full h-9  
         shadow-md hover:shadow-lg hover:opacity-95
         transform transition duration-150 ease-in-out hover:scale-105
         focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2'  onClick={() => handleChapter('add')}>+ Add Chapter</div>

          {showPopup && (
            <div className='fixed inset-0  flex items-center justify-center bg-gray-800 bg-opacity-50'>
              <div className='bg-white  text-gray-700 p-8 rounded-xl relative w-full max-w-80'>
                <h2 className='text-lg  font-bold'>Add Lecture</h2>

                <div className='mb-2 mt-5 '>
                  <p className='text-md font-semibold mb-2'>Lecture Title</p>
                  <input type="text"
                ...
                <div className='mb-2'>
                  <p className='text-md font-semibold mb-2'>Duration (minutes)</p>
                  <input type="number"
                    className='mt-1 block w-full border rounded py-1 px-2'
                ...
                <div className='mb-7'>
                  <p className='text-md font-semibold mb-2'>Lecture URL</p>
                  <input type="text"
                    className='mt-1 block w-full border rounded py-1 px-2'
                ...
                <div className='mb-2 flex'>
                  <p className='text-md font-semibold'>Is Preview Free?</p>
                  <input type="checkbox"
                ...
                <button onClick={addLecture} type='button' className=' mt-3 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700
       text-white font-semibold rounded-lg w-[100px] h-9  
         shadow-md hover:shadow-lg hover:opacity-95
         transform transition duration-150 ease-in-out hover:scale-105
         focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2'>Add</button>
        ...
        <button type='submit' className='bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700
       text-white font-semibold rounded-lg w-[100px] h-9  
         shadow-md hover:shadow-lg hover:opacity-95
         transform transition duration-150 ease-in-out hover:scale-105
         focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2'>Add</button>

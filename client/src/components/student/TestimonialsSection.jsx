...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
       ...
       <p className='md:text-base text-gray-500 mt-3'>Our learners share their journeys of transformation, their measurable successes, and how our <br /> platform has driven real improvements in their lives.</p>
